...
-- MB CargueOptimizado
INSERT INTO PUBLICADOR_WS_METODOS_OPERACIONES (metodoOperacion, descripcionMetdOperacion,idClasePrincipalMetdOperacion,idClaseMetdRetornoOperacion)VALUES ('changedTipoArchivoCargue',null,@idClaseCargueOptimizadoMB,null);
DECLARE @idMetChangedTipoArchivoCargue INT
SET @idMetChangedTipoArchivoCargue = (SELECT idMetodoOperacion FROM PUBLICADOR_WS_METODOS_OPERACIONES WHERE metodoOperacion LIKE 'changedTipoArchivoCargue')
...
INSERT INTO PUBLICADOR_WS_EJECUCION_OPERACION_CLIENTE(idOperacion,idMetodoOperacion,idClaseToBuildInst,idClassManageBeanFind,ordenEjecucion) VALUES(@idOpRealizarCargue,@idMetChangedTipoArchivoCargue,NULL,NULL,5)
